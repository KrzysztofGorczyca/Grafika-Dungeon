...
// ----------------------STATIC FUNCTIONS----------------------
// LOADING TEXTURE FROM initializeTextures()
...
// CONFIGURING TEXTURE WITH SET PARAMETERS IN loadTexture()
...
// UPDATING UNIFORMS IN UPDATE FROM updateUniformsOuter()
